...
public class SimpleController {
	...
	/*
	 * 
	 * PathVariable란? path뒤에 /뒤에 값을 전달하고 서버가 전달 받을 수 있다. /images/aaa.jpg fileName(
	 * 경로변수=> aaa.jpg) /images/aaa /images/aaaa.jpeg /images/{fileName:.*}" 패턴은
	 * 일반적으로 웹 애플리케이션에서 URL 경로를 처리하기 위해 사용되는 패턴
	 */
